...
theme.useless_gap = 2
theme.font = "Roboto Nerd Font Regular 10"
-- theme.bg_focus = nil
-- theme.bg_urgent = nil
...
theme.hotkeys_font = "Iosevka david35mm Regular 10"
...
theme.notification_font = "Iosevka david35mm Regular 10"
-- theme.notification_bg = theme.colour_black
-- theme.notification_fg = theme.colour_white
